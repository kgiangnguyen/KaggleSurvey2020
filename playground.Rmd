...
clust_info <- input_cluster %>%
  ...
  summarize(Age = get_mode(Q1),
            ...
            `Years of Machine Learning` = get_mode(Q15)) %>%
  mutate(Degree = ifelse(Degree == "Masterâ€™s degree", "Master's Degree", ifelse(Degree == "Bachelorâ€™s degree", "Bachelor's degree", Degree))) %>%
  rename(Cluster = cluster)

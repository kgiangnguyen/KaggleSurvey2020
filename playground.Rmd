...
# Plot radar chart
q20_cluster_1 <- rbind(rep(max(q20_cluster_1),15), rep(0,15), q20_cluster_1)
radarchart(q20_cluster_1, title = "Cluster 1")

q20_cluster_2 <- rbind(rep(max(q20_cluster_2),15), rep(0,15), q20_cluster_2)
radarchart(q20_cluster_2, title = "Cluster 2")

q20_cluster_3 <- rbind(rep(max(q20_cluster_3),15), rep(0,15), q20_cluster_3)
...
# Plot radar chart
q21_cluster_1 <- rbind(rep(max(q21_cluster_1),15), rep(0,15), q21_cluster_1)
radarchart(q21_cluster_1, title = "Cluster 1")

q21_cluster_2 <- rbind(rep(max(q21_cluster_2),15), rep(0,15), q21_cluster_2)
radarchart(q21_cluster_2, title = "Cluster 2")

q21_cluster_3 <- rbind(rep(max(q21_cluster_3),15), rep(0,15), q21_cluster_3)
...
# Plot radar chart
q22_cluster_1 <- rbind(rep(max(q22_cluster_1),15), rep(0,15), q22_cluster_1)
radarchart(q22_cluster_1, title = "Cluster 1")

q22_cluster_2 <- rbind(rep(max(q22_cluster_2),15), rep(0,15), q22_cluster_2)
radarchart(q22_cluster_2, title = "Cluster 2")

q22_cluster_3 <- rbind(rep(max(q22_cluster_3),15), rep(0,15), q22_cluster_3)
...
q23_cluster_1 <- rbind(rep(max(q23_cluster_1),15), rep(0,15), q23_cluster_1)
radarchart(q23_cluster_1, title = "Cluster 1")

q23_cluster_2 <- rbind(rep(max(q23_cluster_2),15), rep(0,15), q23_cluster_2)
radarchart(q23_cluster_2, title = "Cluster 2")

q23_cluster_3 <- rbind(rep(max(q23_cluster_3),15), rep(0,15), q23_cluster_3)
...
# Plot radar chart
q24_cluster_1 <- rbind(rep(max(q24_cluster_1),15), rep(0,15), q24_cluster_1)
radarchart(q24_cluster_1, title = "Cluster 1")

q24_cluster_2 <- rbind(rep(max(q24_cluster_2),15), rep(0,15), q24_cluster_2)
radarchart(q24_cluster_2, title = "Cluster 2")

q24_cluster_3 <- rbind(rep(max(q24_cluster_3),15), rep(0,15), q24_cluster_3)

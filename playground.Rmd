...
While the experts are mostly scientists, researchers, the junior team are students, or working at various positions within the data science field. 
The outsiders are either unemployed, not working in the field (others) or even students (they could be those pursuing a master degree or a bachelor in another field. 
...
In terms of company size, three groups all have similar shape as ‘0-44 employees’ is the most popular size.
However, the first group also work for companies with bigger scope
...
The expert team mostly work at the place where ML methods have been well established while junior peers work at the place where ML method are being explored. The outsider, however, work at the place where people do not exploit ML 
...
As indicated in Q5, the expert team’s jobs are mostly data scientists and researchers, therefore their work will focus more on building/running prototypes to explore applying machine learning to new areas even though they still support business decisions with their data analysis.
The junior team are typical data analysts whose responsibilities mainly focus on analyzing and understand data to support business and products.
...
How much a data science job can bring to you? This question is always in people’s interest, especially those who just start the career or those who’re thinking about switching. According to the results in Q24, people who just join in the path will receive up to \$50K, but no more than \$150K. However, The compensations will increase overtime, and salary range can get bigger for the experts from 0 – \$50K to \$100K – \$150K or even more than \$200K
...
Python is the programming language that is used on a regular basis according to all groups. SQL is the second language that is used according to data science insiders (the expert & the junior). Since Python is not only capable of the statistical/modelling side of data sciencem, but also implement non-statistical functionality, it’s reasonable to stay as the most popular choice. Besides, SQL is very powerful in extracting, manipulating and loading data so it’s very common in data analytics as part of business intelligence process. 
It’s very interesting that, the outsiders also use R in addition to Python. This also makes sense as R is exclusively powerful for statistical analysis and modelling, it’s usually helpful for people who want to leverage their foundation of data science. Python, on the other hand, is used more for machine learning, deep learning, NLP – the more advanced side of data science.
...
As a result of Q7, Q8 clearly indicates the language that everyone should prioritize to learn first if they would like to “communicate” in the data science world.  Ideally, an individual can master other languages like SQL or R but in the long run, Python is the way to go.
